                    ...
                    <td class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                      <div class="flex">
                        <div class="image-fit zoom-in h-9 w-9">
                          <img src="{{ asset('img') }}/team/{{ $team->avatar }}" alt="Product Image"
                          ...
                          <div data-transition="" data-selector=".show"
                            ...
                            <div data-tw-merge=""
                              ...
                              <a data-tw-merge data-tw-toggle="modal" data-tw-target="#update" href="#"
                                data-avatar="{{ $team->avatar }}" data-name="{{ $team->nama_team }}"
                                data-token="{{ $team->token_team }}" data-mentor="{{ $team->mentor->name ?? '' }}"
                                data-deskripsi="{{ $team->deskripsi }}"
                                class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item"><i
                                  data-tw-merge="" data-lucide="check-square" class="stroke-[1] mr-2 h-4 w-4"></i>
                                Edit</a>
          ...
          <div class="mt-3">
            ...
            <label class="area-drop inline-block h-64 w-full cursor-pointer">
              ...
              <div
                ...
                <img class="pratinjau-gambar h-60 object-cover rounded-xl hidden" src="" alt="Pratinjau">
