...
@section('content')
        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <a data-tw-merge data-tw-toggle="modal" data-tw-target="#button-modal-preview" href="#"
    ...
    {{-- store modal --}}
    <div data-tw-backdrop="" aria-hidden="true" tabindex="-1" id="button-modal-preview"
