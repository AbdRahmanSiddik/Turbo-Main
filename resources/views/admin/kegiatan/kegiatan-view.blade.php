                            ...
                            <tbody>
                                <tr class="[&_td]:last:border-b-0">
                                    ...
                                    <td
                                        ...
                                        <div class="flex">
                                            <div class="image-fit zoom-in h-9 w-9">
                                                <img src="dist/images/products/product4-400x400.jpg" alt="Product Image"
                                            ...
                                            <div class="image-fit zoom-in -ml-3 h-9 w-9">
                                                <img src="dist/images/products/product5-400x400.jpg" alt="Product Image"
                                                    class="tooltip cursor-pointer rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]">
                                            </div>
                                            <div class="image-fit zoom-in -ml-3 h-9 w-9">
                                                <img src="dist/images/products/product3-400x400.jpg" alt="Product Image"
                                                    class="tooltip cursor-pointer rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]">
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                        ...
                                        <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">Tags: Beauty, Personal
                                            Hygiene, Self-care</div>
                                    </td>
                                    <td
                                        class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                                    ...
                                    <td
                                        ...
                                        <a class="flex items-center text-primary" href="#">
                                            ...
                                            <div class="ml-1.5 w-56 truncate whitespace-nowrap">/8-cup-coffee-maker</div>
                                        </a>
                                    </td>
                                    <td
                                        class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                                                    ...
                                                    <div
                                                        ...
                                                        <a
                                                            ...
                                                            <i data-lucide="trash2"
                                                                class="stroke-[1] mr-2 h-4 w-4"></i>Delete
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
