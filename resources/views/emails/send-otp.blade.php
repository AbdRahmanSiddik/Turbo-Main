...
<head>
    ...
    <title>OTP untuk {{ $user['name'] }}</title>
</head>
    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background: #ffffff; margin: 20px auto; border-radius: 8px; box-shadow: 0px 2px 10px rgba(0,0,0,0.1);">
        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="font-size: 14px; color: #555;">Berikut adalah kode OTP Anda:</p>

                <table width="100%" cellpadding="5" cellspacing="0" style="font-size: 14px; color: #333; border-collapse: collapse;">
                    <tr>
                        <td style="font-weight: bold; width: 120px;">Kode OTP</td>
                        <td>: <strong>{{ $otp }}</strong></td>
                    </tr>
                </table>

                <p style="font-size: 14px; color: #555; margin-top: 20px;">Silakan gunakan kode ini untuk melanjutkan proses verifikasi. Kode ini akan kedaluwarsa dalam 10 menit.</p>
            </td>
        </tr>
