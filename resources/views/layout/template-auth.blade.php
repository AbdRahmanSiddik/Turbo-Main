                            ...
                            <div class="mt-5 grid grid-cols-2 gap-x-5 gap-y-3.5">
                                    ...
                                    <a href="echo-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/echo.png"
                                ...
                                <div>
                                    <a href="hurricane-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/hurricane.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="ravage-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/ravage.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="hook-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/hook.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="razor-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/razor.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="havoc-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/havoc.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="dagger-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/dagger.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="shuriken-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/shuriken.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="raze-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/raze.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="exort-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/exort.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="viper-dashboard-overview-1.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('') }}assets/dist/images/themes/viper.png"
                                                alt="Tailwise - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
