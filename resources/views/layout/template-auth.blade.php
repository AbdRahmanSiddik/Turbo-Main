<!DOCTYPE html>
    ...
    <body>
                        ...
                        <div class="flex flex-col">
                            <div class="px-8 pb-8 pt-6">
                                ...
                                <div class="mt-5 grid grid-cols-2 gap-x-5 gap-y-3.5">
                                    ...
                                    <div>
                                        <a href="razor-dashboard-overview-1.html" class="h-28 cursor-pointer bg-slate-50 box p-1 block border-2 border-theme-1/60">
                                            <div class="h-full w-full overflow-hidden rounded-md">
                ...
                <div class="sticky top-0 z-10 flex-col justify-center hidden h-screen ml-16 lg:flex xl:ml-28 2xl:ml-36">
                    ...
                    <div class="flex flex-col gap-3 mt-10 xl:flex-row xl:items-center">
                        <div class="flex items-center">
                            ...
                            <div class="-ml-3 image-fit zoom-in h-9 w-9 2xl:h-11 2xl:w-11">
                                <img data-placement="top" title="Leonardo DiCaprio" src="dist/images/users/user3-50x50.jpg" alt="Tailwise - Admin Dashboard Template" class="tooltip cursor-pointer rounded-full border-[3px] border-white/50">
                            </div>
                        </div>
        ...
        <script src="dist/js/vendors/alert.js"></script>
        ...
        <script src="dist/js/components/base/tippy.js"></script> <!-- END: Vendor JS Assets-->
        <!-- BEGIN: Pages, layouts, components JS Assets-->
        <!-- END: Pages, layouts, components JS Assets-->
    </body>

    <!-- Mirrored from tailwise-html.vercel.app/razor-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jan 2025 16:40:15 GMT -->
    </html>
